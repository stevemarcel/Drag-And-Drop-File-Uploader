...
// Add hover state to the form when the user drags a file over it
...
// Remove hover state from the form when the user drags a file away from it or drops it
...
// Remove hover state when the user drags a file away from the form or drops it
